      ...
      <>
        <Section title="My work">
          ...
          >
            ...
            <p>
              <a href="https://rfs-ltd.co.uk" title="Russell Financial Solutions website">
          ...
          >
            <p>
              An infographic was created to explore an aeroplane of the future. Working closely with
              the designer, the template and responsive infographic were created using HTML5 and
              jQuery.
            </p>
          </Work>
        </Section>
