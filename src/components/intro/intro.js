      ...
      <div className={this.state.visible ? style.containerVisible : style.container}>
        ...
        <div className={style.content}>
          ...
          <ul className={style.list}>
            <li>
              <a href="https://medium.com/@andrew_barnes" title="Medium">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.231 24">
                  <path d="M3.585,4.9A1.17,1.17,0,0,0,3.2,3.909L.382.508V0H9.146l6.774,14.858L21.876,0h8.355V.508L27.818,2.822a.707.707,0,0,0-.268.678v17a.706.706,0,0,0,.268.676l2.357,2.314V24H18.319v-.508l2.442-2.371c.239-.239.239-.31.239-.676V6.7L14.213,23.945H13.3L5.391,6.7V18.259a1.6,1.6,0,0,0,.437,1.325L9,23.436v.509H0v-.509l3.176-3.852a1.535,1.535,0,0,0,.409-1.325V4.9Z" transform="translate(0)" />
                </svg>
              </a>
            </li>
            <li>
              <a href="https://twitter.com/AndrewBarnesWeb" title="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.532 24">
            ...
            <li>
              <a href="https://www.linkedin.com/in/andrewbarnes102/" title="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.043 24">
            ...
            <li>
              <a href="https://www.instagram.com/andybarnes102/" title="Instagram">
