        ...
        <div className={style.skills}>
          <div className={style.skillsContainer}>
            <SkillCard icon="code" skill="Web development">
              <p>
                I have been building websites for as long as I can remember. I am a strong
                believer in an accessible and fast web, by coding in a way that everyone can enjoy.
              </p>
            </SkillCard>
          </div>
          <div className={style.skillsContainer}>
            <SkillCard icon="design" skill="UI design">
              <p>
                I&apos;m experienced in designing clean and accessible user interfaces.
                From wireframes to high fidelity designs. I like to make things look nice!
              </p>
            </SkillCard>
          </div>
        </div>
        ...
        <div className={style.info}>
          <div className={style.text}>
            ...
            <p>
              ...
              me to create designs that people will be comfortable using from the start.
              I am well versed in Sketch and XD to create pixel perfect designs.
            </p>
            <p>
