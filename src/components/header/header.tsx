...
const Header = () => {
  ...
  return (
    <header className={visible ? style.containerVisible : style.container}>
      <div className={showMenu ? style.menuContainerActive : style.menuContainer}>
        <svg
        ...
        >
          <span className={showMenu ? style.menuIconActive : style.menuIcon} />
        </button>
        <nav aria-label="Main navigation">
          <ul className={showMenu ? style.navActive : style.nav}>
            <li>
            ...
            <li>
              <a onClick={handleClick} href="#what-i-do">
                What I do
              </a>
            </li>
            <li>
            ...
            <li>
              <a onClick={handleClick} href="#my-work">
                My work
              </a>
            </li>
            <li>
