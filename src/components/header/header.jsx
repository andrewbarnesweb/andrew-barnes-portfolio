        ...
        >
          ...
          <nav aria-label="Main navigation">
            <ul className={condition ? style.navActive : style.nav}>
              <li>
                <a onClick={this.handleClick} href="#about-me">
                  About me
                </a>
              </li>
              <li>
                <a onClick={this.handleClick} href="#what-i-do">
                  What I do
                </a>
              </li>
              <li>
                <a onClick={this.handleClick} href="#blog">
                  Blog
                </a>
              </li>
              <li>
                <a onClick={this.handleClick} href="#my-work">
                  My work
                </a>
              </li>
              <li>
